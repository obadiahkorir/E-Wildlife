 ...
 <div class="clear"></div>
				...
				<ul class="slider-items">
					<li>
						...
						<div class="slide-entry">
							<h2><span> Lions Take A Look </span></h2>
					...
					<li>
						...
						<div class="slide-entry">
							<h3><span>View </span><span class="small">The Hippos</span></h3> 
							<a href="index.php" class="button" onclick="alert('Please Sign IN to Make Reservations!')"  title="BOOK NOW"><span>BOOK NOW</span></a>
						</div>
					</li>
					<li>
    ...
    if ($results) { 
        ...
        while($obj = $results->fetch_object())
        {
            ...
            echo '<div class="product-content"><h2><b>'.$obj->animal_name.'</b> </h2>';
			...
			echo '</div></div>';
            echo '<input type="hidden"  value="'.$obj->animals_id.'" />';
