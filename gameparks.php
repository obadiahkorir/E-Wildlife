 ...
 <div class="clear"></div>
		...
		<div id="main" class="shell">
			...
			<div id="product-slider">
		  	...
		  	<?php
			$result=mysqli_query($conn,"select * from gamepark") or die (mysqli_error());
			while($row=mysqli_fetch_array($result)){
		?>
					<li>
						<a href="gameparks.php" title="Gameparks"><img src="images/<?php echo $row['Picture']?>" alt="IMAGES" /></a>
						<div class="info">
							<h4><b><?php echo $row['Gamepark']?></b></h4>
...
<?php
$result = mysqli_query($conn,"SELECT * FROM parks");
?>
...
<?php while($row = mysqli_fetch_array($result))
  {
   ...
   <td><?php echo $row['animals']; ?></td>
    ...
    <td> <a href="Sign In.php?booking=<?php echo $row['park_name']; ?>"  onClick="edit(this);" title="BOOKING" >  <input type="image" src="images/book.png" title="BOOK NOW"> </a>
   </td>
    </tr>
