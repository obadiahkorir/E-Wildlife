...
<?php
$result = mysqli_query($conn,"SELECT * FROM registration where email='$login_session'");
?>
      <div id="tab1" class="tab_content">
  <table class="tablesorter" cellspacing="0"> 

		<thead>  <th Colspan="9">  E-WildLife User Profile</th></thead>
		<thead>
		<thead>
			</tr>
   		    <th>Check ID</th> 
...
<?php while($row = mysqli_fetch_array($result))
  {?>
   ...
   <td><?php echo $row['email']; ?></td>
    ...
    <td> <a href="wareViewUpdate.php?update=<?php echo $row['user_id']; ?>"  onClick="edit(this);" title="empEdit" >  <input type="image" src="images/icn_edit.png" title="Edit"> </a>
     <a href="DeleteWarehouse.php?delete=<?php echo $row['user_id']; ?>" onClick="del(this);" title="Delete" ><input type="image" src="images/icn_trash.png" title="Trash">  </a></td>
    </tr>
