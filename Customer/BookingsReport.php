...
$w=array(50,70,40,85,30,20,20,20,18,15,15,15,15);
	...
	{ //width
		$this->Cell(50,6,$eachResult["Reserved_Id"],1);
		$this->Cell(70,6,$eachResult["FullNames"],1);
		$this->Cell(40,6,$eachResult["Username"],1);
		$this->Cell(85,6,$eachResult["email"],1);
		$this->Cell(30,6,$eachResult["No_Of_People"],1);
		$this->Cell(20,6,$eachResult["From_Date"],1);
		$this->Cell(50,6,$eachResult["To_Date"],1);
		$this->Cell(40,6,$eachResult["Site"],1);
		$this->Cell(30,6,$eachResult["Price"],1);
		$this->Cell(20,6,$eachResult["Adress"],1);
		$this->Cell(10,6,$eachResult["PostalCode"],1);
...
$header=array('ID','Full Names','USER NAME','EMAIL','NO OF PEOPLE','FROM-DATE','TO-DATE','SITE','PRICE','ADDRESS','POSTAL CODE');
//Data loading
//*** Load MySQL Data ***//
...
$currDate = date('Y-m-d');
$strSQL = "Select* from bookings where email='$login_session'";
...
$pdf->AddPage();
	...
	$pdf->Cell(55);
	$pdf->Write(5, 'CUSTOMER BOOKINGS REPORTS');
	$pdf->Ln();
