...
?>
  ...
  <table class="tablesorter" cellspacing="0"> 
			...
			<thead><tr> <th colspan="7"><h2>TOURIST DETAILS MANAGEMENT DASHBORD</h2></th>  </tr> <thead>
		<thead>
			<tr>
   		    <th>CHECK</th> 
            <th>CUSTOMER ID</th>			  
...
<?php while($row = mysqli_fetch_array($result))
  {
	...
	<td> <a href="bookingsViewUpdate.php?update=<?php echo $row['Cust_Id']; ?>"  onClick="edit(this);" title="empEdit" >  <input type="image" src="images/icn_edit.png" title="Edit"> </a>
