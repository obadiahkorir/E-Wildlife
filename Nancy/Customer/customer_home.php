	...
	<section id="secondary_bar">
            <nav>
                <ul>
                    ...
                    <li><a href="UserDetials.php">PROFILE</a></li>
                     <li><a href="animals.php">ANIMALS</a></li>
                     <li><a href="News.php">NEWS</a></li>
                    <li><a href="Gameparks.php">GAMEPARKS</a></li>
                    <li><a href="GameReserves.php">GAMERESERVES</a></li>
...
<aside id="sidebar" class="column">
		...
		<ul class="toggle">
		    <li class="icn_categories"><a href="Register_Details.php">Register</a></li>
		      <li class="icn_categories"><a href="Backup.php">Book</a></li>
		        <li class="icn_categories"><a href="Backup.php">View Bookings</a></li>
	...
	<section id="main" class="column">
		...
		<h4 class="alert_info">Welcome To <strong>"E-WILDLIFE MANAGEMENT SYSTEM"</strong></h4> 
