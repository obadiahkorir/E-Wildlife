...
<SCRIPT language="Javascript">
      ...
      function isNumberKey(evt)
      {
         ...
         var charCode = (evt.which) ? evt.which : event.keyCode
		  window.alert("Please In A Age Field Only Numbers is  Allowed !!!");
	...
	<div id="form_wrapper" class="form_wrapper">
		 ...
		 <table>
					...
					<th colspan="3"><h2>PLEASE REGISTER WITH US:</h2> </th> 
...
<span class="error">This is an error</span>
   ...
   <tr>
    <td>  
		...
		<label>Age:</label>0
		<input type="int"  name="age"  id="age"  onkeypress="return isNumberKey(event)"  required>
		<span class="error">This is an error</span>
