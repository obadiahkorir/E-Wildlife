...
<?php
$result = mysqli_query($mysqli,"SELECT * FROM reserves");
?>
...
<?php while($row = mysqli_fetch_array($result))
  {
   ...
   <td><?php echo $row['animals']; ?></td>
    ...
    <td> <a href="booking.php?booking=<?php echo $row['reserve_name']; ?>"  onClick="edit(this);" title="BOOKING" >  <input type="image" src="images/book.png" title="BOOK NOW"> </a>
   </td>
    </tr>
