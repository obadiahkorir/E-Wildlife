	...
	<section id="secondary_bar">
             <nav>
                <ul>
                    ...
                    <li><a href="add_panimals.php">Add Animals</a></li>
...
<aside id="sidebar" class="column">
		...
		<h3>Reports:</h3>
		<ul class="toggle">
		    <li class="icn_settings"><a href="OrderReports.php">servations  Report</a></li>
		...
		<ul class="toggle">
			...
			<li class="icn_new_article"><a href="add_gamereserves.php">Add GameReserves</a></li>
	...
	<h4 class="alert_info">Welcome To <strong>"E-WILDLIFE MAMAGEMENT SYSTEM"</strong> Admin Panel As:   </h4>
...
<SCRIPT language="Javascript">
	...
	<div id="form_wrapper" class="form_wrapper">
		 ...
		 <table>
					...
					<th colspan="3"><h2>ADD ANIMALS:</h2> </th> 
 ...
 <?php
include('../config.php');
$name= mysqli_query($mysqli,"select * from gameparks");
...
?>
   ...
   <td>   
		...
		<span class="error">This is an error</span>
			...
			<button name="save" id="delbutton" title="Click to Save"  class="a-btn" > <span class="a-btn-text"> REGISTER ANIMAL</span></</button>
			<div class="clear"></div>
			</div>
...
?>
  ...
  <table class="tablesorter" cellspacing="0"> 
			...
			<thead>  <th Colspan="11">  E-WILDLIFE DATA TABLE </th></thead>
		<thead>
			</tr>
   		      <th>Check</th> 
    	      <th>ID</th>
   ...
   <td><?php echo $row['Description']; ?></td>
    ...
    <td> <a href="prodViewUpdate.php?update=<?php echo $row['ANIMAL_ID']; ?>"  onClick="edit(this);" title="empEdit" >  <input type="image" src="images/icn_edit.png" title="Edit"> </a>
     <a href="prodDelete.php?delete=<?php echo $row['ANIMAL_ID']; ?>" onClick="del(this);" title="Delete" class="delbutton"><input type="image" src="images/icn_trash.png" title="Trash">  </a></td>
    </tr>
