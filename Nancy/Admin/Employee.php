	...
	<section id="secondary_bar">
             ...
             <nav><!-- Defining the navigation menu -->
                <ul>
                    ...
                    <li><a href="add_warehouse.php">Add GamePark</a></li>
                    <li><a href="add_product.php">Add GameReserve</a></li>
...
<aside id="sidebar" class="column">
	...
	<h4 class="alert_info">Welcome To <strong>"E-WILDLIFE"</strong> Admin Panel As:  </h4>
