	...
	<section id="secondary_bar">
             ...
             <nav><!-- Defining the navigation menu -->
                <ul>
                    ...
                    <li><a href="add_category.php">Add Gameparks</a></li>
...
<form class="register active" id="myForm" action="insertCategory.php" method="POST" name="addEmployee" >
					...
					<th colspan="3"><h2>REGISTER NEW PARKS</h2> </th> 
   ...
   <tr>
						...
						<button name="submit" id="save" title="Click to Save"  class="a-btn"> <span class="a-btn-text">REGISTER PARK</span></button>
