...
<div id="container">
	...
	<center><h1>E-WILDLIFE CUSTOMER PANEL</h1></center>
<div id="content-wrap">		
	<section id="secondary_bar">
            ...
            <nav>
                <ul>
                    ...
                    <li><a href="add_animal.php">REGISTER</a></li>
                    <li><a href="add_gamepark.php">BOOKINGS</a></li>
                    <li><a href="add_gamereserves.php">PROFILE</a></li>
                     <li><a href="Employee.php">ANIMALS</a></li>
                     <li><a href="Employee.php">NEWS</a></li>
                    <li><a href="add_category.php">GAMEPARKS</a></li>
                    <li><a href="Employee.php">GAMERESERVES</a></li>
...
<aside id="sidebar" class="column">
		...
		<ul class="toggle">
			...
			<li class="icn_settings"><a href="EmployeeReport.php">Booking History</a></li>
			<li class="icn_settings"><a href="ProductReport.php"> WildLife Report</a></li>
     		
		</ul>
		
        <h3>E-WILDLIFE DETAILS:</h3>
		<ul class="toggle">
