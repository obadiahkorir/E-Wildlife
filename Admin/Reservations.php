...
<aside id="sidebar" class="column">
    ...
    <tr>
       ...
       <td>  
		...
		<input type="text" id="no" name="no" placeholder="No of People" />
		<span class="error">This is an error</span>
                               
	</td>
 <td>  
		<label>Reserved Site:</label>
		<input type="text" id="site" name="site" placeholder="Reserved site" />
		<span class="error">This is an error</span>
 ...
 <td>  
		...
		<input type="text" id="fee" name="fee" placeholder="Entrance Fee" />
		<span class="error">This is an error</span>
