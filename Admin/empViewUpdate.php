...
<?php if($row = mysqli_fetch_array($result))
  {?> 
   ...
   <td>
		<input type="hidden" id="ID" name="ID" value="<?php echo $row['id'];?>"  placeholder="Full name" required>
    ...
    <td>  
	  ...
	  <label>Full Name:</label>
		...
		<input type="text" id="name" name="name" value="<?php echo $row['names'];?>"  placeholder="Full name" required>
		<span class="error">This is an error</span>
	</td>
   <td>   
